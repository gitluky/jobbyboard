    ...
    <>
      <Container maxWidth="lg">
        ...
        >
          ...
          <Route exact path='/posts/new' render={routerProps => <PostForm {...routerProps} session={session} domain={domain} classes={classes} method={"POST"} alerts={alerts} updateErrors={updateErrors} clearAlerts={clearAlerts} updateNotifications={updateNotifications}/>}/>
          <Route exact path='/users/:user_id/posts/:id/edit' render={routerProps => <PostForm {...routerProps} session={session} domain={domain} classes={classes} method={"PATCH"} alerts={alerts} updateErrors={updateErrors} clearAlerts={clearAlerts} updateNotifications={updateNotifications} posts={users[session.id] ? users[session.id].attributes.active_posts : []}/> }/>
